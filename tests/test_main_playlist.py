...
main_playlist('https://www.youtube.com/playlist?list=PLS1QulWo1RIaJECMeUT4LFwJ-ghgoSH6n', end=4)

main_playlist('PLS1QulWo1RIaJECMeUT4LFwJ-ghgoSH6n', start=3, end=5)